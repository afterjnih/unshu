...
React.render(React.createElement(Tweet, {name: "John", text: "hello osaka"}), document.body);

var Tweets = React.createClass({displayName: "Tweets",
  render: function(){
    return(
      React.createElement("div", {className: "tweets"}, 
        React.createElement(Tweet, {name: "John", text: "hello Fukuoka"}), 
        React.createElement(Tweet, {name: "Mary", text: "hello Okinawa"})
      )
    );
  }
});

React.render(React.createElement(Tweets, null), document.body);
